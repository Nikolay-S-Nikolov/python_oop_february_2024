class Concert:
    ...
    @genre.setter
    def genre(self, genre_type: str):
        if genre_type not in self.GENRE_TYPES:
            raise ValueError(f"Our group doesn't play {genre_type}!")
        self.__genre = genre_type
